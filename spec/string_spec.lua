describe('string', function()
  ...
  it("zjoin", function()
    assert.is_nil((''):zjoin())
    assert.is_nil(string.zjoin(''))
    assert.is_nil(string.zjoin('', nil))
    assert.is_nil(string.zjoin('', nil, nil))
    assert.is_nil(string.zjoin('', nil, nil, nil))
    assert.is_nil(string.zjoin('', '', nil))
    assert.is_nil(string.zjoin(':', '', nil))
    assert.is_nil(string.zjoin('', '', ""))
    assert.is_nil(string.zjoin(':', '', ""))
    assert.equal("x", string.zjoin('', '', "x"))
    assert.equal("x", string.zjoin('', 'x', ""))
    assert.equal("x", string.zjoin(':', 'x', ""))
    assert.equal("x", string.zjoin(':', '', "x"))
    assert.equal("google.com", string.zjoin('.', "google", "com"))
    assert.equal("www.google.com", string.zjoin('.', "www", "google", "com"))
  end)
