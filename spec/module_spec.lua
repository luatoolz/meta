describe('module', function()
  ...
  it(".pkg", function()
    assert.equal(module('testdata/init1').loader, module:pkg('testdata/init1/file'))
    assert.equal(module('testdata/init1/dir').loader, module:pkg('testdata/init1/dir'))
    assert.equal(module('testdata/init1/dirinit').loader, module:pkg('testdata/init1/dirinit'))
    assert.equal(module('testdata/init1').loader, module:pkg('testdata/init1/filedir'))
    assert.equal(module('testdata/init1').loader, module:pkg('testdata/init1/all'))

    assert.equal(module('testdata/init2').loader, module:pkg('testdata.init2'))
    assert.equal(module('testdata/init2').loader, module:pkg('testdata.init2.file'))
    assert.equal(module('testdata/init2/dir').loader, module:pkg('testdata.init2.dir'))
    assert.equal(module('testdata/init2/dirinit').loader, module:pkg('testdata.init2.dirinit'))
    assert.equal(module('testdata/init2').loader, module:pkg('testdata.init2.filedir'))
    assert.equal(module('testdata/init2').loader, module:pkg('testdata.init2.all'))
  end)
end)
