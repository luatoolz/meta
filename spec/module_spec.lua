...
--[[  it(".basename", function()
  ...
  it(".isroot", function()
    ...
    assert.is_false(module('init2').isroot)
  ...
  it(".pkg", function()
    ...
    assert.equal(module('testdata/init1/dir'), module:pkg('testdata/init1/dir'))
    assert.equal(module('testdata/init1/dirinit'), module:pkg('testdata/init1/dirinit'))
    assert.equal(module('testdata/init1'), module:pkg('testdata/init1/filedir'))
    assert.equal(module('testdata/init1'), module:pkg('testdata/init1/all'))
    ...
    assert.equal(module('testdata/init2/dir'), module:pkg('testdata.init2.dir'))
    assert.equal(module('testdata/init2/dirinit'), module:pkg('testdata.init2.dirinit'))
    assert.equal(module('testdata/init2'), module:pkg('testdata.init2.filedir'))
    assert.equal(module('testdata/init2'), module:pkg('testdata.init2.all'))
  end)
  it(".d", function()
    local mod = module('testdata'):sub('assert')
