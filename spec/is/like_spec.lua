describe("is.like", function()
  ...
  it("negative", function()
    ...
    assert.is_nil(is.like(1, 0))
    assert.is_nil(is.like(true, false))
    assert.is_nil(is.like('','a'))
    assert.is_nil(is.like('a','b'))
    assert.is_nil(is.like(table(),string.lower))
    assert.is_nil(is.like(string.lower,string.upper))
  end)
  it("nil", function()
