describe('string', function()
  ...
  it("__call", function()
    ...
    assert.equal('a b', string('  a b '))
    assert.equal('a+b', string(setmetatable({' a','b '}, {__tostring=function(self) return self[1]..'+'..self[2] end})))
  ...
  if debug and debug.getmetatable and getmetatable("") ~= nil then
    ...
    it("mt", function()
      assert.is_not_nil(getmetatable(string))
