describe('no', function()
  ...
  describe('call', function()
    ...
    it("other", function()
      ...
      assert.has_error(function() return no.call(function()
        error('err');
        return 'test', 'two'
      end) end)
    end)
  ...
  it("noneexistent", function()
    assert.has_error(function() return no.require('testdata.noneexistent') end)
  end)
  it("failed", function()
    assert.is_nil(package.loaded['nothing_existent'])
    assert.is_nil(package.loaded['testdata.failed'])
    assert.has_error(function() return no.require('testdata.failed') end)
  end)
  it("or", function()
    assert.has_error(function() return no.require('testdata.noneexistent') or no.require('testdata.ok') end)
    assert.truthy(no.require('testdata.ok') or no.require('testdata.noneexistent'))
    assert.has_error(function() return no.require('testdata.noneexistent') or no.require('os') end)
    assert.truthy(no.require('os') or no.require('testdata.noneexistent'))
    assert.has_error(function() return (no.require('testdata.noneexistent') or no.require('os')).remove end)
  end)
