...
--    assert.not_nil(select(2, no.require('testdata.noneexistent')))
  ...
  it("failed", function()
    ...
    local a, b = no.require('testdata.failed')
    local _ = b
--    assert.not_nil(b)
    assert.is_nil(a)

--    assert.not_nil(select(2, no.require('testdata.failed')))
    assert.is_nil(select(1, no.require("testdata.failed")))
--    assert.not_nil(select(2, no.require('testdata.failed')))
    assert.is_nil(select(1, no.require("testdata.failed")))
  end)
  it("or", function()
  ...
  describe('cache:load', function()
    ...
    it("string", function() assert.is_nil(load('testdata/loader/noinit')) end)
  end)
