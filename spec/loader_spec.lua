describe('loader', function()
  ...
  it("eq meta", function()
    ...
    assert.equal(getmetatable(require("meta")), getmetatable(loader))
    assert.equal(getmetatable(loader), getmetatable(require("meta")))
    assert.equal(getmetatable(meta), getmetatable(loader))
    assert.equal(getmetatable(meta("meta")), getmetatable(loader("meta")))
  end)
  it("req", function()
